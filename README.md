...
- **Dashboard** — Role-aware: org-wide metrics and charts for Admin/HR, team view for Managers, a personal view for Employees.
...
A deliberately lightweight setup — no locale-prefixed routes, no extra dependency:
